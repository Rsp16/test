...
function katateksnimasi(){
      ...
      afterComplete: function(){
        ...
        stikerdua.style="opacity:0;transform:scale(0)";
        setTimeout(gantifotodua,400);
...
function menuju(){
  if(fungtom2==1){
    var pesan = encodeURIComponent(pesanwhatsapp || "Boleh nih, mau PAP? ><");
    window.location = "https://wa.me/6287782185321?text=" + pesan;
  }
}
